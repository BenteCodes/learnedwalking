...
import WalkingNetwork_one_inputpattern
import random
import numpy as np
import vrep
import math
...
class GA_Gait_one_inputpattern:
    ...
    def __init__(self, size, mutation_rate, crossover_rate, iterations, step):
        ...
        while i < size:
            ...
            while j < self.networksize:
                ...
                j = j + 1
            new_network = WalkingNetwork_one_inputpattern.WalkingNetwork_one_inputpattern(weights, self.robot, self.clientID, self.step)
...
# map fittness function and output to get the error
    ...
    def getBestNetworks(self):
        ...
        for index in bestIndizes:
            bestFitness.append(fitnessList[index])
    ...
    def createMutantNetwork(self, network):
        ...
        child_network = WalkingNetwork_one_inputpattern.WalkingNetwork_one_inputpattern(new_weights, self.robot, self.clientID, self.step)
    ...
    def safeFitness(self, meanfitness, best5Fitness):
        ...
        with open('fitnessonepattern_static.csv', 'a') as csvfile1:
    ...
    def safeNetwork(self, network):
        with open('networkonepattern_static.csv', 'wb') as csvfile:
...
testGA = GA_Gait_one_inputpattern(150, 20, 10, 1000, 2)
GA_Gait_one_inputpattern.evolve(testGA)
